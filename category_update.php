    ...
    <div class="col-12">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-white mb-4">
                ...
                <li class="breadcrumb-item"><a href="<?php echo $url; ?>/category_list.php">Category Lists</a></li>
            ...
            <div class="card-body">
                ...
                <form method="get">
                    <div class="form-inline">
                        ...
                        <input type="text" name="message" value="<?php echo $row['message'] ?>" class="form-control mr-2"  required>
